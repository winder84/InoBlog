...
class Edit extends \Ino\Blog\Controller\Adminhtml\Article
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('ino_blog_article', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Article %1', $model->getId()) : __('New Article'));
        return $resultPage;
    }
}
